...
public class PollIntervalDialog extends JDialog {
    ...
    private static final String TITLE_STRING = "KeepAlive - Set interval";
    private static final String FORM_STRING = "Specify poll interval (in seconds):";
    ...
    private void initDialog() {
    	...
    	Object[] controls = { FORM_STRING, textField };
    ...
    private boolean checkValue(String txt) {
        if (txt != null && txt.length() > 0) {
            ...
            if (txt.length() <= maxPollInterval.toString().length()) {
                try {
                	...
                	LogHelper.LogMessage("INFO", "Unexpected error checking input value: " + e.getMessage() );
                }
            }
        }
        ...
        JOptionPane.showMessageDialog(
        		this, 
        		"Please specify value in range " + minPollInterval + " - " + maxPollInterval, 
        		"Wrong value", 
